...
class HTMLElement{
	...
	HTMLELement createElementNS(`namespaceURI"http://www.w3.org/1999/xhtml"| "http://www.w3.org/2000/svg"|"http://www.w3.org/1998/Math/MathML"`, string tag)
...
### setAttributeNS(namespaceURI: string, tag: string)
